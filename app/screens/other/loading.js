...
class loadingScreen extends React.Component {
  ...
  state = {
    ...
    load: [
      ...
      {
        f: this.props.getNotificationMessage(),
        r: this.props.notification.message
      },
      {
        f: this.props.getNotificationAlert(),
        r: this.props.notification.alert
      },
      {
        f: this.props.getNotificationComing(),
        r: this.props.notification.coming
      },
  ...
  updateProgress = () => {
    if (this.props.profile && this.props.notification) {
      ...
      const randProgress =
        this.state.load.reduce((a, b) => a + (b.r ? 1 : 0), 0) /
        this.state.load.length;
      ...
      <View>
        ...
        <View style={styles.text}>
          <RkText
            rkType="light"
            style={
              this.props.profile !== undefined ? styles.loaded : styles.hero
            }
          >
            Profile
          </RkText>
          <RkText
            rkType="light"
            style={this.props.modules ? styles.loaded : styles.hero}
          >
            Module
          </RkText>
          <RkText
            rkType="light"
            style={
              this.props.notification.message ? styles.loaded : styles.hero
            }
          >
            Messages
          </RkText>
          <RkText
            rkType="light"
            style={this.props.notification.alert ? styles.loaded : styles.hero}
          >
            Alert
          </RkText>
          <RkText
            rkType="light"
            style={this.props.notification.coming ? styles.loaded : styles.hero}
          >
            Coming
          </RkText>
        </View>
